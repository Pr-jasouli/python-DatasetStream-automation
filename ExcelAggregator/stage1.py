...
REFERENCE_DATA_DIR = os.path.join(BASE_DIR, 'reference data')
OUTPUT_DIR = os.path.join(BASE_DIR, 'results/tsv')
...
def process_directory(folder_path):
    ...
    latest_files = glob.glob(os.path.join(REFERENCE_DATA_DIR, 'Product_Grouping_Latest*.xlsx'))
    if not latest_files:
        logging.error("No files starting with 'Product_Grouping_Latest' found in 'reference data' directory.")
        return
